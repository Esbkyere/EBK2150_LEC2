...
```
    ...
    ## # A tibble: 49 × 5
    ##    group gd0_weight gd18_weight gd_of_birth pups_born_alive
    ##    <chr>      <dbl>       <dbl>       <dbl>           <dbl>
    ##  1 Con7        19.7        34.7          20               3
    ##  2 Con7        27          42            19               8
    ##  3 Con7        26          41.4          19               6
    ##  4 Con7        28.5        44.1          19               5
    ##  5 Con7        NA          NA            20               6
    ##  6 Con7        NA          NA            20               6
    ##  7 Con7        NA          NA            20               9
    ##  8 Con8        NA          NA            20               9
    ##  9 Con8        NA          NA            20               8
    ## 10 Con8        28.5        NA            20               8
    ## # ℹ 39 more rows
...
You can also rename specific columns as part of the procedure when
selecting them
...
Lets say you want to put litter numbers at the first column and also
keep everything
...
Note that below he used two equal to signs becuase hes not trying to
make that variable 20 hes trying to say if the value is 20 then keep
that row.
...
In the next one the exclamation mark negates so now it will give you all
the rows where gdofbirth is not 20
...
What of the data is not numeric, lets say you want to keep any row with
the categorical value “Con7” in it
...
In the example below we will create a new variable called weight
gain(gestational weight on day 18 - gestational weight on day 0). We can
also in the same statement change the data in the column group to lower
case letters)
...
\##arrange we put pups born alive in order
